...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/jamelsingh/Tamilcatuserbot) to open this bot source code\
        \nClick [here](https://github.com/jamelsingh/catpack) to open supported link for heroku",
    )
