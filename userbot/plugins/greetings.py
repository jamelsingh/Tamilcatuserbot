...
async def hbd(event):
    ...
    await edit_or_reply(
        event,
        f"▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃\n✩ ⋆｡˚ ✩✩ ⋆｡˚ ✩✩ ⋆｡˚ ✩ ⋆｡˚ ✩\n╮╭╭╮┏╮┏╮╮╭    ✩ ⋆｡˚  ✩ ⋆｡˚\n┣┫┣┫┣╯┣╯╰┫     ☆  ✩ ⋆ ⋆｡˚ ✩\n╯╯╯╯╯╯╯╯╰╯╭━┻━╮ ✩ ⋆｡˚\n┏╮⋆ ┏╮╭╮╮╭╭┻━━━┻╮ ⋆｡˚ ✩\n┣┫ ⋆┃┃┣┫╰┫┣╮╭╮╭╮┃⋆✩｡˚\n┗╯⋆ ┗╯╯╯╰╯┃╰╯╰╯╰┫✩｡˚\n━━━━━━━━━╯/////\\\\\╰━━━\n🎂என்றும் ஆரோக்கியத்தோடும்\n🎂நிறைவான தன்னம்பிகையோடும்\n🎂உன் வாழ்க்கையை வெல்ல\n🎂வெள்ளை உள்ளத்தோடும்\n🎂மனம் நிறைந்த மகிழ்ச்சியோடும்\n🎂இன்று போல நூறாண்டு வாழ பிறந்தநாளில் வாழ்த்தும்\nஅன்புடன் உன் நண்பன்.🥰\n ☻/\n/█   🌷 🥰🤩🥳😍👦🥰💐\n/ \   \|/ 🧥🥼👚👗🧥👘💐\n██████████████████\n\n\n{text}",
    )


@catub.cat_cmd(
    pattern="sunday$",
    command=("sunday", plugin_category),
    info={
        "header": "happy Sunday art.",
        "usage": "{tr}sunday",
    },
)
async def gm(event):
...
async def luck(event):
    "Missu art."
    await edit_or_reply(
        event, "╔═╗╔═╦══╦═══╦═══╗\n║║╚╝║╠╣╠╣╔═╗║╔═╗║\n║╔╗╔╗║║║║╚══╣╚══╗\n║║║║║║║║╚══╗╠══╗║\n║║║║║╠╣╠╣╚═╝║╚═╝║\n╚╝╚╝╚╩══╩═══╩═══╝\n\n──╔╗──╔╦═══╦╗─╔╗\n──║╚╗╔╝║╔═╗║║─║║\n──╚╗╚╝╔╣║─║║║─║║\n───╚╗╔╝║║─║║║─║║\n────║║─║╚═╝║╚═╝║\n────╚╝─╚═══╩═══╝\n\n\n💚ஒரு கல்லுல I Miss you ன்னு எழுதிஅதை உன் முகத்துலயேவிட்டெறிஞ்சா புரியும்..உன்னை எவ்ளோ Miss பண்றேன்னு அதோட வலி எப்படின்னு...எரும மாடே..😂💚"
    )
